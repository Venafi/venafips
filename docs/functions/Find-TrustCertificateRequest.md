...
```
Find-TrustCertificateRequest [-Status <String[]>] [-Application <String[]>] [-User <String[]>]
...
### AdvancedFilter
```
Find-TrustCertificateRequest -Filter <System.Collections.Generic.List`1[System.Object]> [-Order <PSObject[]>]
