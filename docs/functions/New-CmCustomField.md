...
```
New-CmCustomField [-Name] <String> [-Label] <String> [-Class] <String[]> [-Type] <String>
...
### EXAMPLE 1
```
New-CmCustomField -Name "Last Date" -Label "Last Date" -Class "X509 Certificate" -Type "String" -RenderReadOnly -Help "Last Date of certificate import"
...
[https://venafi.github.io/VenafiPS/functions/New-CmCustomField/](https://venafi.github.io/VenafiPS/functions/New-CmCustomField/)
