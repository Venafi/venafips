...
```
Add-CmAdaptableHash [-Path] <String> [[-Keyname] <String>] [-FilePath] <String> [[-TrustClient] <TrustClient>]
...
[https://venafi.github.io/VenafiPS/functions/Add-CmAdaptableHash/](https://venafi.github.io/VenafiPS/functions/Add-CmAdaptableHash/)

[https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Add-CmAdaptableHash.ps1](https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Add-CmAdaptableHash.ps1)
