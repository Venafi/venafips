...
### Matrix
```
Remove-CmEngineFolder -FolderPath <String[]> -EnginePath <String[]> [-TrustClient <TrustClient>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### AllEngines
```
Remove-CmEngineFolder -FolderPath <String[]> [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### AllFolders
```
Remove-CmEngineFolder -EnginePath <String[]> [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://venafi.github.io/VenafiPS/functions/Remove-CmEngineFolder/](https://venafi.github.io/VenafiPS/functions/Remove-CmEngineFolder/)

[https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Remove-CmEngineFolder.ps1](https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Remove-CmEngineFolder.ps1)
