...
```
Move-CmObject [-SourcePath] <String> [-TargetPath] <String> [[-TrustClient] <TrustClient>]
...
### EXAMPLE 1
```
Move-CmObject -SourceDN '\VED\Policy\My Folder\mycert.company.com' -TargetDN '\VED\Policy\New Folder\mycert.company.com'
Move object to a new Policy folder
```

### EXAMPLE 2
```
Find-CmCertificate -Path '\ved\policy\certs' | Move-CmObject -TargetDN '\VED\Policy\New Folder'
...
[https://venafi.github.io/VenafiPS/functions/Move-CmObject/](https://venafi.github.io/VenafiPS/functions/Move-CmObject/)

[https://venafi.github.io/VenafiPS/functions/Test-CmObject/](https://venafi.github.io/VenafiPS/functions/Test-CmObject/)

[https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Move-CmObject.ps1](https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Move-CmObject.ps1)
