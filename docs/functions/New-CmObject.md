...
### NonDup (Default)
```
New-CmObject -Path <String> -Class <String> [-Attribute <Hashtable>] [-PushCertificate] [-Force] [-PassThru]
 [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Dup
```
New-CmObject -Path <String> [-SourcePath <String>] [-PushCertificate] [-Force] [-PassThru]
 [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### EXAMPLE 1
```
New-CmObject -Path '\VED\Policy\Test Device' -Class 'Device' -Attribute @{'Description'='new device testing'}
```
...
### EXAMPLE 2
```
New-CmObject -Path 'missing\folder\again' -Class 'Policy' -Force
```
...
### EXAMPLE 3
```
New-CmObject -Path '\VED\Policy\Test Device' -Class 'Device' -Attribute @{'Description'='new device testing'} -PassThru
```
...
### EXAMPLE 4
```
New-CmObject -Path '\VED\Policy\Test Device\App' -Class 'Basic' -Attribute @{'Driver Name'='appbasic';'Certificate'='\Ved\Policy\mycert.com'}
```
...
### EXAMPLE 5
```
New-CmObject -Path 'certificates\duplicate.company.com' -SourcePath 'certificates\original.company.com'
```
...
### -PassThru
Return a CmObject representing the newly created object.
...
[https://venafi.github.io/VenafiPS/functions/New-CmObject/](https://venafi.github.io/VenafiPS/functions/New-CmObject/)
...
[https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Add-CmCertificateAssociation.ps1](https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Add-CmCertificateAssociation.ps1)
