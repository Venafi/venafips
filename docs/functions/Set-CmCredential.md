...
### Password (Default)
```
Set-CmCredential -Path <String> -Password <PSObject> [-Expiration <DateTime>] [-TrustClient <TrustClient>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CertificatePath
```
Set-CmCredential -Path <String> -Password <PSObject> -CertificatePath <String> [-Expiration <DateTime>]
 [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Certificate
```
Set-CmCredential -Path <String> -Password <PSObject> -Certificate <X509Certificate2> [-Expiration <DateTime>]
 [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UsernamePassword
```
Set-CmCredential -Path <String> -Password <PSObject> -Username <String> [-Expiration <DateTime>]
 [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CertificateLinkPath
```
Set-CmCredential -Path <String> -CertificateLinkPath <String> [-Expiration <DateTime>]
 [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### EXAMPLE 1
```
Set-CmCredential -Path '\VED\Policy\Password Credential' -Password 'my-new-password'
```
...
### EXAMPLE 2
```
Set-CmCredential -Path '\VED\Policy\UsernamePassword Credential' -Password 'my-new-password' -Username 'greg'
```
...
### EXAMPLE 3
```
Set-CmCredential -Path '\VED\Policy\Certificate Credential' -Password 'my-pk-password' -Certificate $p12
```
...
### EXAMPLE 4
```
Set-CmCredential -Path '\VED\Policy\Password Credential' -Password 'my-new-password' -Expiration (Get-Date).AddDays(30)
```
...
### EXAMPLE 5
```
Set-CmCredential -Path '\VED\Policy\Certificate Credential' -CertificateLinkPath '\VED\Policy\Certificates\newcert.domain.com'
```
...
[https://venafi.github.io/VenafiPS/functions/Set-CmCredential/](https://venafi.github.io/VenafiPS/functions/Set-CmCredential/)

[https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Set-CmCredential.ps1](https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Set-CmCredential.ps1)
