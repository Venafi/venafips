...
```
Remove-CmClient [-ClientID] <String[]> [-RemoveAssociatedDevice] [[-TrustClient] <TrustClient>]
...
### EXAMPLE 1
```
Remove-CmClient -ClientId 1234, 5678
Remove clients
```

### EXAMPLE 2
```
Remove-CmClient -ClientId 1234, 5678 -RemoveAssociatedDevice
...
[https://venafi.github.io/VenafiPS/functions/Remove-CmClient/](https://venafi.github.io/VenafiPS/functions/Remove-CmClient/)

[https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Remove-CmClient.ps1](https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Remove-CmClient.ps1)
