...
```
Find-TrustLog [-EventType <String[]>] [-EventName <String[]>] [-Message <String>] [-Critical]
...
### AdvancedFilter
```
Find-TrustLog -Filter <System.Collections.Generic.List`1[System.Object]> [-Order <PSObject[]>] [-First <Int32>]
 [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Find-TrustLog -EventType 'Authentication'
```
...
### EXAMPLE 3
```
Find-TrustLog -DateFrom (Get-Date).AddDays(-7) -Message "certificate"
```
...
### EXAMPLE 4
```
Find-TrustLog -EventType 'Authentication' -Message 'failed' -IncludeAny
```
...
### EXAMPLE 5
```
Find-TrustLog -Filter @('and', @('activityDate', 'gt', (get-date).AddMonths(-1)), @('or', @('message', 'find', 'greg@venafi.com'), @('message', 'find', 'bob@venafi.com')), @('activityType','eq','Authentication'))
```
...
### EXAMPLE 6
```
Find-TrustLog -EventType 'Authentication' -Order 'activityDate'
```
...
### EXAMPLE 7
```
Find-TrustLog -EventType 'Authentication' -Order @{'activityDate'='desc'}
```
...
### EXAMPLE 8
```
Find-TrustLog -EventType 'Authentication' -Order @{'activityDate'='desc'}, 'criticality'
```
