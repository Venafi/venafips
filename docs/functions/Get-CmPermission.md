...
### ByObject (Default)
```
Get-CmPermission -InputObject <PSObject> [-IdentityId <String[]>] [-Explicit] [-TrustClient <TrustClient>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### ByPath
```
Get-CmPermission -Path <String[]> [-IdentityId <String[]>] [-Explicit] [-TrustClient <TrustClient>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### ByGuid
```
Get-CmPermission -Guid <Guid[]> [-IdentityId <String[]>] [-Explicit] [-TrustClient <TrustClient>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### -InputObject
CmObject representing an object in Certificate Manager, Self-Hosted, eg.
from Find-CmObject or Get-CmObject
...
[https://venafi.github.io/VenafiPS/functions/Get-CmPermission/](https://venafi.github.io/VenafiPS/functions/Get-CmPermission/)

[https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Get-CmPermission.ps1](https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Get-CmPermission.ps1)

[https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Get-CmIdentityAttribute.ps1](https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Get-CmIdentityAttribute.ps1)
