...
### ID (Default)
```
Get-CmsApplication [-Application] <String> [-IncludeConfig] [-TrustClient <TrustClient>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### All
```
Get-CmsApplication [-IncludeConfig] [-All] [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
