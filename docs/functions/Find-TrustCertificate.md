# Find-TrustCertificate

## SYNOPSIS
Find certificates in Certificate Manager, SaaS

## SYNTAX

### SimpleFilter (Default)
```
Find-TrustCertificate [-Name <String>] [-KeyLength <Int32>] [-Serial <String>] [-Fingerprint <String>]
...
### AdvancedFilter
```
Find-TrustCertificate -Filter <System.Collections.Generic.List`1[System.Object]> [-Order <PSObject[]>]
 [-ApplicationDetail] [-OwnerDetail] [-First <Int32>] [-TrustClient <TrustClient>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### SavedSearch
```
Find-TrustCertificate [-Order <PSObject[]>] -SavedSearchName <String> [-ApplicationDetail] [-OwnerDetail]
...
### EXAMPLE 2
```
Find-TrustCertificate -First 500
```
...
### EXAMPLE 3
```
Find-TrustCertificate -Name 'mycert.company.com'
```
...
### EXAMPLE 4
```
Find-TrustCertificate -Fingerprint '075C43428E70BCF941039F54B8ED78DE4FACA87F'
```
...
### EXAMPLE 5
```
Find-TrustCertificate -ExpireAfter (get-date) -ExpireBefore (get-date).AddDays(30)
```
...
### EXAMPLE 6
```
Find-TrustCertificate -ExpireAfter (get-date) -ExpireBefore (get-date).AddDays(30)| Invoke-TrustCertificateAction -Renew
```
...
### EXAMPLE 7
```
Find-TrustCertificate -Filter @('subjectDN', 'FIND', 'www.barron.com')
```
...
### EXAMPLE 8
```
Find-TrustCertificate -ApplicatonDetail
```
...
### EXAMPLE 9
```
Find-TrustCertificate -OwnerDetail
```
