...
### ByFile (Default)
```
Import-TrustCertificate -Path <String> [-PrivateKeyPassword <PSObject>] [-ThrottleLimit <Int32>] [-Recurse]
 [-Force] [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### ByData
```
Import-TrustCertificate -Data <String> [-Format <String>] [-PrivateKeyPassword <PSObject>]
 [-ThrottleLimit <Int32>] [-Force] [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>] [-WhatIf]
...
### EXAMPLE 1
```
Import-TrustCertificate -CertificatePath c:\www.VenafiPS.com.pfx
```
...
### EXAMPLE 4
```
Find-TrustCertificate | Export-TrustCertificate -PrivateKeyPassword 'secretPassword#' -PKCS12 | Import-TrustCertificate -TrustClient $tenant2_key
```
