...
### NonIis (Default)
```
New-CmCapiApplication -Path <String> [-ApplicationName <String[]>] [-CertificatePath <String>]
 [-CredentialPath <String>] [-FriendlyName <String>] [-Description <String>] [-WinRmPort <Int32>] [-Disable]
 [-PushCertificate] [-SkipExistenceCheck] [-PassThru] [-TrustClient <TrustClient>]
...
New-CmCapiApplication -Path <String> [-ApplicationName <String[]>] [-CertificatePath <String>]
 ...
 [-CreateBinding <Boolean>] [-PushCertificate] [-SkipExistenceCheck] [-PassThru] [-TrustClient <TrustClient>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### EXAMPLE 1
```
New-CmCapiApplication -Path '\ved\policy\mydevice\capi' -CertificatePath $cert.Path -CredentialPath $cred.Path
Create a new application
```

### EXAMPLE 2
```
New-CmCapiApplication -Path '\ved\policy\mydevice\capi' -CertificatePath $cert.Path -CredentialPath $cred.Path -WebSiteName 'mysite' -BindingIp '1.2.3.4'
Create a new application and update IIS
```

### EXAMPLE 3
```
New-CmCapiApplication -Path '\ved\policy\mydevice\capi' -CertificatePath $cert.Path -CredentialPath $cred.Path -WebSiteName 'mysite' -BindingIp '1.2.3.4' -PushCertificate
Create a new application, update IIS, and push the certificate to the new app
```

### EXAMPLE 4
```
New-CmCapiApplication -Path '\ved\policy\mydevice\capi' -CertificatePath $cert.Path -CredentialPath $cred.Path -PassThru
Create a new application and return a CmObject for the newly created app
```
...
### -PassThru
Return a CmObject representing the newly created capi app.
...
[https://venafi.github.io/VenafiPS/functions/New-CmCapiApplication/](https://venafi.github.io/VenafiPS/functions/New-CmCapiApplication/)

[https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/New-CmCapiApplication.ps1](https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/New-CmCapiApplication.ps1)

[https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/New-CmObject.ps1](https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/New-CmObject.ps1)

[https://venafi.github.io/VenafiPS/functions/Find-CmCertificate/](https://venafi.github.io/VenafiPS/functions/Find-CmCertificate/)
