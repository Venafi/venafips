...
### Id (Default)
```
Get-CmCertificate [-ID] <String> [-IncludeStatus] [-ThrottleLimit <Int32>] [-TrustClient <TrustClient>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### IdWithPrevious
```
Get-CmCertificate [-ID] <String> [-IncludePreviousVersions] [-ExcludeExpired] [-ExcludeRevoked]
 [-IncludeStatus] [-ThrottleLimit <Int32>] [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### AllWithPrevious
```
Get-CmCertificate [-All] [-IncludePreviousVersions] [-ExcludeExpired] [-ExcludeRevoked] [-IncludeStatus]
...
### All
```
Get-CmCertificate [-All] [-IncludeStatus] [-ThrottleLimit <Int32>] [-TrustClient <TrustClient>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### EXAMPLE 1
```
Get-CmCertificate -ID '\ved\policy\mycert.com'
```
...
### EXAMPLE 3
```
Get-CmCertificate -ID '\ved\policy\mycert.com' -IncludePreviousVersions
```
...
### EXAMPLE 4
```
Get-CmCertificate -ID '\ved\policy\mycert.com' -IncludePreviousVersions -ExcludeRevoked -ExcludeExpired
```
