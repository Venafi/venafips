...
### ID (Default)
```
Get-TrustMachine [-Machine] <String> [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### All
```
Get-TrustMachine [-All] [-IncludeConnectionDetail] [-TrustClient <TrustClient>]
