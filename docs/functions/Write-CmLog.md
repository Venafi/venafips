...
```
Write-CmLog [-CustomEventGroup] <String> [-EventId] <String> [-Component] <String>
 [[-Severity] <CmEventSeverity>] [[-SourceIp] <IPAddress>] [[-ComponentID] <Int32>]
 [[-ComponentSubsystem] <String>] [[-Text1] <String>] [[-Text2] <String>] [[-Value1] <Int32>]
 [[-Value2] <Int32>] [[-TrustClient] <TrustClient>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### EXAMPLE 1
```
Write-CmLog -CustomEventGroup '0200' -EventId '0001' -Component '\ved\policy\mycert.com'
...
[https://venafi.github.io/VenafiPS/functions/Write-CmLog/](https://venafi.github.io/VenafiPS/functions/Write-CmLog/)

[https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Write-CmLog.ps1](https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Write-CmLog.ps1)
