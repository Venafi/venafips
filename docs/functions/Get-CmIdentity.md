...
### Id (Default)
```
Get-CmIdentity -ID <String> [-IncludeAssociated] [-IncludeMembers] [-TrustClient <TrustClient>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Me
```
Get-CmIdentity [-Me] [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### All
```
Get-CmIdentity [-All] [-IncludeAssociated] [-IncludeMembers] [-TrustClient <TrustClient>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
