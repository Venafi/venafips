...
### All (Default)
```
Find-TrustMachineIdentity [-Status <String[]>] [-Machine <String>] [-Certificate <String>]
...
### Filter
```
Find-TrustMachineIdentity -Filter <System.Collections.Generic.List`1[System.Object]> [-Order <PSObject[]>]
