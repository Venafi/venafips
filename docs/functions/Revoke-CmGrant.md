...
```
Revoke-CmGrant [[-ID] <String[]>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://venafi.github.io/VenafiPS/functions/Revoke-CmGrant/](https://venafi.github.io/VenafiPS/functions/Revoke-CmGrant/)

[https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Revoke-CmGrant.ps1](https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Revoke-CmGrant.ps1)
