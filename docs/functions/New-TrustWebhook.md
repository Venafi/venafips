...
### EventName (Default)
```
New-TrustWebhook -Name <String> [-Type <String>] -Url <String> -EventName <String[]> [-Secret <String>]
 [-CriticalOnly] [-PassThru] [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### EventType
```
New-TrustWebhook -Name <String> [-Type <String>] -Url <String> -EventType <String[]> [-Secret <String>]
 [-CriticalOnly] [-PassThru] [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
### EXAMPLE 1
```
New-TrustWebhook -Name 'MyWebhook' -Url 'https://my.com/endpoint' -EventType 'Authentication'
```
...
### EXAMPLE 2
```
New-TrustWebhook -Name 'MyWebhook' -Url 'https://my.com/endpoint' -EventType 'Authentication' -Type slack
```
...
### EXAMPLE 3
```
New-TrustWebhook -Name 'MyWebhook' -Url 'https://my.com/endpoint' -EventType 'Authentication', 'Certificates', 'Applications'
```
...
### EXAMPLE 4
```
New-TrustWebhook -Name 'MyWebhook' -Url 'https://my.com/endpoint' -EventName 'Certificate Validation Started'
```
...
### EXAMPLE 5
```
New-TrustWebhook -Name 'MyWebhook' -Url 'https://my.com/endpoint' -EventType 'Certificates' -CriticalOnly
```
...
### EXAMPLE 6
```
New-TrustWebhook -Name 'MyWebhook' -Url 'https://my.com/endpoint' -EventType 'Authentication' -Secret 'MySecret'
```
...
### EXAMPLE 7
```
New-TrustWebhook -Name 'MyWebhook' -Url 'https://my.com/endpoint' -EventType 'Authentication' -PassThru
```
