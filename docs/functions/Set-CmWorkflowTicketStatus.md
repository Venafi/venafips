...
```
Set-CmWorkflowTicketStatus [-TicketGuid] <Guid[]> [-Status] <String> [[-Explanation] <String>]
 [[-ScheduledStart] <DateTime>] [[-ScheduledStop] <DateTime>] [[-TrustClient] <TrustClient>]
...
### EXAMPLE 1
```
Get-CmWorkflowTicket -Path '\VED\policy\myapp.company.com' | Set-CmWorkflowTicketStatus -Status Approved
Approve all tickets for a certificate
```

### EXAMPLE 2
```
Get-CmWorkflowTicket -Path '\VED\policy\myapp.company.com' | Set-CmWorkflowTicketStatus -Status 'Approved After' -ScheduledStart (Get-Date).AaaDays(3) -Explanation 'weekend upgrade'
...
[https://venafi.github.io/VenafiPS/functions/Set-CmWorkflowTicketStatus/](https://venafi.github.io/VenafiPS/functions/Set-CmWorkflowTicketStatus/)

[https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Set-CmWorkflowTicketStatus.ps1](https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Set-CmWorkflowTicketStatus.ps1)
