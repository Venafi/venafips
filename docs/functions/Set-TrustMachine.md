...
```
Set-TrustMachine [-Machine] <String> [[-Name] <String>] [[-ConnectionDetail] <Hashtable>]
 [[-Satellite] <String>] [-PassThru] [[-TrustClient] <TrustClient>] [-ProgressAction <ActionPreference>]
...
This should be a hashtable with the same structure as the connectionDetails object returned by Get-TrustMachine. 
