...
```
New-CmTeam [-Name] <String> [-Owner] <String[]> [-Member] <String[]> [[-Policy] <String[]>]
 [-Product] <String[]> [[-Description] <String>] [-PassThru] [[-TrustClient] <TrustClient>]
...
### EXAMPLE 1
```
New-CmTeam -Name 'My New Team' -Member 'local:{803f332e-7576-4696-a5a2-8ac6be6b14e6}' -Owner 'local:{803f332e-7576-4696-a5a2-8ac6be6b14e7}' -Product 'TLS'
```
...
### EXAMPLE 2
```
New-CmTeam -Name 'My New Team' -Member 'local:{803f332e-7576-4696-a5a2-8ac6be6b14e6}' -Owner 'local:{803f332e-7576-4696-a5a2-8ac6be6b14e7}' -Product 'TLS' -Policy '\ved\policy\myfolder'
```
...
### EXAMPLE 3
```
New-CmTeam -Name 'My New Team' -Member 'local:{803f332e-7576-4696-a5a2-8ac6be6b14e6}' -Owner 'local:{803f332e-7576-4696-a5a2-8ac6be6b14e7}' -Product 'TLS' -Description 'One amazing team'
```
...
### EXAMPLE 4
```
New-CmTeam -Name 'My New Team' -Member 'local:{803f332e-7576-4696-a5a2-8ac6be6b14e6}' -Owner 'local:{803f332e-7576-4696-a5a2-8ac6be6b14e7}' -Product 'TLS' -PassThru
```
...
Provide the identity ID property from Find-CmIdentity or Get-CmIdentity.
