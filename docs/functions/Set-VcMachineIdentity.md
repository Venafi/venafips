...
```
Set-VcMachineIdentity [-MachineIdentity] <String> [[-Certificate] <String>] [[-Binding] <Hashtable>]
 [[-Keystore] <Hashtable>] [-Force] [-PassThru] [[-VenafiSession] <PSObject>]
...
Provide a hashtable with the same structure as the binding object returned by Get-VcMachineIdentity.
...
Provide a hashtable with the same structure as the keystore object returned by Get-VcMachineIdentity.
You can provide a partial hashtable with only the values to change.
