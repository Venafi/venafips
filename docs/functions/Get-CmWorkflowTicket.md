...
```
Get-CmWorkflowTicket [-Path] <String[]> [[-TrustClient] <TrustClient>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
[https://venafi.github.io/VenafiPS/functions/Get-CmWorkflowTicket/](https://venafi.github.io/VenafiPS/functions/Get-CmWorkflowTicket/)

[https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Get-CmWorkflowTicket.ps1](https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Get-CmWorkflowTicket.ps1)
