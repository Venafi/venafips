...
### NotPolicy (Default)
```
Set-CmAttribute -Path <String> -Attribute <Hashtable> [-BypassValidation] [-NoOverwrite]
 [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Policy
```
Set-CmAttribute -Path <String> -Attribute <Hashtable> -Class <String> [-Lock] [-BypassValidation]
 [-NoOverwrite] [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### EXAMPLE 1
```
Set-CmAttribute -Path '\VED\Policy\My Folder\app.company.com' -Attribute @{'Consumers'='\VED\Policy\myappobject.company.com'}
```
...
### EXAMPLE 2
```
Set-CmAttribute -Path '\VED\Policy\My Folder\app.company.com' -Attribute @{'Management Type'=$null}
```
...
### EXAMPLE 3
```
Set-CmAttribute -Path '\VED\Policy\My Folder\app.company.com' -Attribute @{'My custom field Label'='new custom value'}
```
...
### EXAMPLE 4
```
Set-CmAttribute -Path '\VED\Policy\My Folder\app.company.com' -Attribute @{'My custom field Label'='new custom value'} -BypassValidation
```
...
### EXAMPLE 5
```
Set-CmAttribute -Path '\VED\Policy\My Folder' -Class 'X509 Certificate' -Attribute @{'Notification Disabled'='0'}
```
...
### EXAMPLE 6
```
Set-CmAttribute -Path '\VED\Policy\My Folder' -Class 'X509 Certificate' -Attribute @{'Notification Disabled'='0'} -Lock
```
...
### EXAMPLE 7
```
Set-CmAttribute -Path '\VED\Policy\app.company.com' -Attribute @{'X509 SubjectAltName IPAddress'='1.2.3.4'; 'X509 SubjectAltName DNS'='me.x.com'}
```
...
[https://venafi.github.io/VenafiPS/functions/Set-CmAttribute/](https://venafi.github.io/VenafiPS/functions/Set-CmAttribute/)

[https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Set-CmAttribute.ps1](https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Set-CmAttribute.ps1)
...
[https://docs.venafi.com/Docs/current/TopNav/Content/SDK/WebSDK/r-SDK-POST-Config-clearattribute.php](https://docs.venafi.com/Docs/current/TopNav/Content/SDK/WebSDK/r-SDK-POST-Config-clearattribute.php)

[https://docs.venafi.com/Docs/current/TopNav/Content/SDK/WebSDK/r-SDK-POST-Config-clearpolicyattribute.php](https://docs.venafi.com/Docs/current/TopNav/Content/SDK/WebSDK/r-SDK-POST-Config-clearpolicyattribute.php)
