...
```
Get-CmCustomField [-Class] <String> [[-TrustClient] <TrustClient>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
### EXAMPLE 1
```
Get-CmCustomField -Class 'X509 Certificate'
...
[https://venafi.github.io/VenafiPS/functions/Get-CmCustomField/](https://venafi.github.io/VenafiPS/functions/Get-CmCustomField/)
