...
### PEM (Default)
```
Export-TrustCertificate -ID <String> [-PrivateKeyPassword <PSObject>] [-IncludeChain] [-OutPath <String>]
 [-ThrottleLimit <Int32>] [-Force] [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### PKCS12
```
Export-TrustCertificate -ID <String> -PrivateKeyPassword <PSObject> [-OutPath <String>] [-PKCS12] [-UseLegacy]
 [-ThrottleLimit <Int32>] [-Force] [-TrustClient <TrustClient>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
### EXAMPLE 1
```
$certId | Export-TrustCertificate
```
...
### EXAMPLE 2
```
$certId | Export-TrustCertificate -PrivateKeyPassword 'myPassw0rd!'
```
...
### EXAMPLE 3
```
$certId | Export-TrustCertificate -PrivateKeyPassword 'myPassw0rd!' -PKCS12 -OutPath '~/temp'
```
...
### EXAMPLE 4
```
$cert | Export-TrustCertificate -OutPath '~/temp'
```
...
### EXAMPLE 5
```
$cert | Export-TrustCertificate -IncludeChain
```
...
Use Find-TrustCertificate or Get-TrustCertificate to determine the ID.
