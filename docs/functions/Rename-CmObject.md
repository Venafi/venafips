...
```
Rename-CmObject [-Path] <String> [-NewPath] <String> [[-TrustClient] <TrustClient>]
...
[https://venafi.github.io/VenafiPS/functions/Rename-CmObject/](https://venafi.github.io/VenafiPS/functions/Rename-CmObject/)

[https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Rename-CmObject.ps1](https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Rename-CmObject.ps1)
