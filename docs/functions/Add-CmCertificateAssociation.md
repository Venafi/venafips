...
```
Add-CmCertificateAssociation [-CertificatePath] <String> [[-ApplicationPath] <String[]>] [-PushCertificate]
...
[https://venafi.github.io/VenafiPS/functions/Add-CmCertificateAssociation/](https://venafi.github.io/VenafiPS/functions/Add-CmCertificateAssociation/)
