...
Describe 'Remove-TrustWebhook' -Tags 'Unit' {
    ...
    It 'Should call the delete API with the correct endpoint' {
        Remove-TrustWebhook -ID $testId -Confirm:$false
