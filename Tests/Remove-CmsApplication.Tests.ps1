...
Describe 'Remove-CmsApplication' -Tags 'Unit' {
    ...
    It 'Should call the delete API with the correct endpoint and UriRoot' {
        Remove-CmsApplication -ID $testId -Confirm:$false
