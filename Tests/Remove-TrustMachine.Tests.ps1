...
Describe 'Remove-TrustMachine' -Tags 'Unit' {
    ...
    It 'Should call the delete API with the correct endpoint' {
        Remove-TrustMachine -ID $testId -Confirm:$false
