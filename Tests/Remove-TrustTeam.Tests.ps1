...
Describe 'Remove-TrustTeam' -Tags 'Unit' {
    ...
    It 'Should call the delete API with the correct endpoint' {
        Remove-TrustTeam -ID $testId -Confirm:$false
