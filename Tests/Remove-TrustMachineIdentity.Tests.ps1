...
Describe 'Remove-TrustMachineIdentity' -Tags 'Unit' {
    ...
    It 'Should call the delete API with the correct endpoint' {
        Remove-TrustMachineIdentity -ID $testId -Confirm:$false
