...
Describe 'Remove-CmsTeam' -Tags 'Unit' {
    ...
    It 'Should call the delete API with the correct endpoint' {
        Remove-CmsTeam -ID $testId -Confirm:$false
