...
function New-CmCustomField {
    ...
    .LINK
    https://venafi.github.io/VenafiPS/functions/New-CmCustomField/
    ...
    begin {
        ...
        if ( $PSCmdlet.ShouldProcess($Label) ) {
            ...
            if ( $response.Result -eq [CmMetadataResult]::Success ) {
                if (( $PassThru )) {
