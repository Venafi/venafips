function Export-TrustCertificate {
    <#
    .SYNOPSIS
    ...
    .PARAMETER ID
    Certificate ID, also known as uuid.  Use Find-TrustCertificate or Get-TrustCertificate to determine the ID.
