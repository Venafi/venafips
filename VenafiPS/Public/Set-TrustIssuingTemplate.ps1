function Set-TrustIssuingTemplate {
    <#
    .SYNOPSIS
    ...
    begin {
        ...
        switch ($PSBoundParameters.Keys ) {
            'CertificateAuthority' {
                $ca = $CertificateAuthority | Get-TrustData -Type 'CertificateAuthority' -Object -FailOnNotFound
    ...
    process {
        ...
        $thisTemplate = $IssuingTemplate | Get-TrustData -Type 'IssuingTemplate' -Object
