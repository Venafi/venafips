function Set-CmCredential {
    ...
    .LINK
    https://venafi.github.io/VenafiPS/functions/Set-CmCredential/

    .LINK
    https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Set-CmCredential.ps1
    ...
    process {
        ...
        $thisType = (Get-CmObject -Path $Path).TypeName
