function Set-CmAttribute {
    ...
    .LINK
    https://venafi.github.io/VenafiPS/functions/Set-CmAttribute/

    .LINK
    https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Set-CmAttribute.ps1
            ...
            if ( $customField ) {
                ...
                if ( -not $BypassValidation ) {
                    switch ( $customField.Type.ToString() ) {
                        ...
                        '5' {
                            # identity
                            if ( -not ($thisValue | Test-CmIdentity -ExistOnly) ) {
    ...
    process {
        ...
        if ( $customFields.Count -gt 0 ) {
            ...
            if ( $response.Result -ne [CmMetadataResult]::Success ) {
                Write-Error $response.Error
            }
        }
    }
