function Remove-TrustIssuingTemplate {
    <#
    .SYNOPSIS
    ...
    [Alias('Remove-VcIssuingTemplate')]
    ...
    process {
        ...
        Invoke-TrustParallel -InputObject $allObjects -ScriptBlock {
            $null = Invoke-TrustRestMethod -Method 'Delete' -UriLeaf "certificateissuingtemplates/$PSItem"
