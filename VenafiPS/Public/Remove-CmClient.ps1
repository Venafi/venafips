function Remove-CmClient {
    ...
    .LINK
        https://venafi.github.io/VenafiPS/functions/Remove-CmClient/

    .LINK
        https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Remove-CmClient.ps1
