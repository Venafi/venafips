function Find-TrustCertificate {
    <#
    .SYNOPSIS
    ...
    switch ($PSCmdlet.ParameterSetName) {
        ...
        'SimpleFilter' {
            ...
            switch ($PSBoundParameters.Keys) {
                ...
                'Application' { $null = $newFilter.Add(@('applicationIds', 'IN', @(($Application | Get-TrustData -Type Application)))) }
                'Tag' {
    ...
    $response = Find-TrustObject @params
