function New-CmDevice {
    ...
    .LINK
    https://venafi.github.io/VenafiPS/functions/New-CmDevice/

    .LINK
    https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/New-CmDevice.ps1
    ...
    begin {
        ...
        # leave .Validate() out as New-CmObject will do it for us later
