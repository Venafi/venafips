function Find-CmObject {
    ...
    .LINK
    https://venafi.github.io/VenafiPS/functions/Find-CmObject/

    .LINK
    https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Find-CmObject.ps1
    ...
    process {
        ...
        $params = @{
            Method = 'Post'
            Body   = @{
                'ObjectDN' = $Path | ConvertTo-CmFullPath
            }
        }
        ...
        foreach ($object in $objects) {
            [CmObject]::new($object.DN, $object.Guid, $object.TypeName)
        }
    }
}
