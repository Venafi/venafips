function Write-CmLog {
    ...
    .LINK
    https://venafi.github.io/VenafiPS/functions/Write-CmLog/

    .LINK
    https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Write-CmLog.ps1
    ...
    if ( $PSBoundParameters.ContainsKey('Severity') ) {
        $params.Body.Add('Severity', [CmEventSeverity]::$Severity)
    }
