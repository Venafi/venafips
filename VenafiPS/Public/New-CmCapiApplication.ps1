function New-CmCapiApplication {
    <#
    .SYNOPSIS
    ...
    .LINK
    https://venafi.github.io/VenafiPS/functions/New-CmCapiApplication/

    .LINK
    https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/New-CmCapiApplication.ps1

    .LINK
    https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/New-CmObject.ps1

    .LINK
    https://venafi.github.io/VenafiPS/functions/Find-CmCertificate/

    .LINK
    https://venafi.github.io/VenafiPS/functions/Get-CmObject/
    ...
    begin {
        ...
        if ( -not $PSBoundParameters.ContainsKey('SkipExistenceCheck') ) {
            ...
            if ( $PSBoundParameters.ContainsKey('CertificatePath') ) {
                ...
                $certObject = Find-CmCertificate -Path $certPath
            ...
            if ( $PSBoundParameters.ContainsKey('CredentialPath') ) {
                ...
                $credObject = Get-CmObject -Path $CredentialPath
    ...
    process {
        ...
        if ( -not $PSBoundParameters.ContainsKey('SkipExistenceCheck') ) {
            ...
            $device = Get-CmObject -Path $devicePath
        ...
        if ( $PSCmdlet.ShouldProcess($Path, 'Create CAPI application(s)') ) {
            ...
            if ( $PushCertificate.IsPresent ) {
                ...
                Invoke-CmCertificateAction @params
            }
