function Invoke-CmCertificateAction {
    <#
    .SYNOPSIS
    ...
    [Alias('Invoke-VdcCertificateAction')]
            ...
            ScriptBlock   = {
                ...
                switch ($action) {
                    'Disable' {
                        ...
                        try {
                            Set-CmAttribute -Path $thisCert -Attribute @{ 'Disabled' = '1' }
                        }
                        catch {
                    ...
                    'Delete' {
                        $performInvoke = $false
                        Remove-CmCertificate -Path $thisCert -Confirm:$false
                    }
                }
