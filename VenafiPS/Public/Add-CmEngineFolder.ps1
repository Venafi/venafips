function Add-CmEngineFolder {
    ...
    .LINK
    https://venafi.github.io/VenafiPS/functions/Add-CmEngineFolder/
    .LINK
    https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Add-CmEngineFolder.ps1
    .LINK
    https://docs.venafi.com/Docs/current/TopNav/Content/SDK/WebSDK/r-SDK-POST-ProcessingEngines-Engine-eguid.php
    #>

    [Alias('Add-VdcEngineFolder')]
    ...
    process {
        if ( -not ($PSBoundParameters.ContainsKey('EngineObject')) ) {
            $EngineObject = Get-CmObject -Path $EnginePath
