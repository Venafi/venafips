function Remove-CmCertificateAssociation {
    <#
    .SYNOPSIS
    ...
    process {
        ...
        if ( -not ($Path | Test-CmObject -ExistOnly) ) {
        ...
        if ( $PSBoundParameters.ContainsKey('ApplicationPath') ) {
            ...
            $associatedApps = $Path | Get-CmAttribute -Attribute "Consumers" | Select-Object -ExpandProperty Consumers
