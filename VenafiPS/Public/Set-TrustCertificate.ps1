function Set-TrustCertificate {
    ...
    begin {
        ...
        switch ($PSCmdlet.ParameterSetName) {
            'Application' {
                $apps = $Application | Get-TrustData -Type 'Application' -FailOnNotFound
            ...
            'Tag' {
                ...
                $tagNames = $Tag | Get-TrustData -Type 'Tag' -Name -FailOnNotFound
    ...
    process {
        if ( Test-IsGuid($Certificate) ) {
            ...
            # search by name
            $certIDs = Get-TrustData -InputObject $Certificate -Type 'Certificate'
