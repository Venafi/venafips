function New-TrustMachineCommonKeystore {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
    New-TrustMachineCommonKeystore -Name 'ck1' -Owner 'MyTeam' -Hostname 'ck1.company.com' -Credential $cred -SshPassword
    ...
    [Alias('New-VcMachineCommonKeystore')]
    ...
    begin {
        ...
        $machineTypeId = Get-TrustData -InputObject 'Common KeyStore (PEM, JKS, PKCS#12)' -Type 'Plugin'
    ...
    process {
        ...
        $response = $allMachines | New-TrustMachine @newParams
