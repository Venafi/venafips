function Remove-TrustMachineIdentity {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
    Remove-TrustMachineIdentity -ID 'ca7ff555-88d2-4bfc-9efa-2630ac44c1f2'
    Remove a machine identity

    .EXAMPLE
    Remove-TrustMachineIdentity -ID 'ca7ff555-88d2-4bfc-9efa-2630ac44c1f2' -Confirm:$false
    Remove a machine identity bypassing the confirmation prompt
    #>

    [CmdletBinding(SupportsShouldProcess, ConfirmImpact = 'High')]
    [Alias('Remove-VcMachineIdentity')]
    ...
    process {
        ...
        Invoke-TrustParallel -InputObject $allObjects -ScriptBlock {
            $null = Invoke-TrustRestMethod -Method 'Delete' -UriLeaf "machineidentities/$PSItem"
