function Move-CmObject {
    ...
    .LINK
    https://venafi.github.io/VenafiPS/functions/Move-CmObject/

    .LINK
    https://venafi.github.io/VenafiPS/functions/Test-CmObject/

    .LINK
    https://github.com/Venafi/VenafiPS/blob/main/VenafiPS/Public/Move-CmObject.ps1
    ...
    begin {
        ...
        try {
            $targetObject = Get-CmObject -Path $TargetPath -ErrorAction SilentlyContinue
        }
        catch {
