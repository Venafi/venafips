...
FunctionsToExport = 'Add-CmsTeamMember', 'Add-CmsTeamOwner', 'Add-CmAdaptableHash',
               ...
               'Export-CmCertificate', 'Export-CmVaultObject',
               'Find-TrustCertificate', 'Find-TrustCertificateInstance',
               'Find-TrustCertificateRequest', 'Find-TrustLog', 'Find-TrustMachine',
               'Find-TrustMachineIdentity', 'Find-CmCertificate', 'Find-CmClient',
               'Find-CmEngine', 'Find-CmIdentity', 'Find-CmObject',
               'Find-CmVaultId', 'Get-CmsApplication', 'Get-TrustCertificate',
               'Get-TrustConnector', 'Get-TrustIssuingTemplate', 'Get-TrustMachine',
               'Get-TrustMachineIdentity', 'Get-TrustSatellite', 'Get-TrustTag', 'Get-CmsTeam',
               'Get-CmsUser', 'Get-TrustWebhook', 'Get-CmAttribute', 'Get-CmCertificate',
               'Get-CmClassAttribute', 'Get-CmCredential', 'Get-CmCustomField',
               'Get-CmEngineFolder', 'Get-CmIdentity', 'Get-CmIdentityAttribute',
               'Get-CmObject', 'Get-CmPermission', 'Get-CmSystemStatus',
               'Get-CmTeam', 'Get-CmWorkflowTicket',
               ...
               'New-TrustMachineIis', 'New-CmsTeam', 'New-TrustWebhook',
               'New-CmCapiApplication', 'New-CmCertificate', 'New-CmCustomField',
               'New-CmDevice', 'New-CmObject', 'New-CmPolicy', 'New-CmTeam',
               'New-TrustClient', 'Read-CmLog',
               'Remove-CmsApplication', 'Remove-TrustCertificate', 'Remove-TrustConnector',
               'Remove-TrustIssuingTemplate', 'Remove-TrustMachine',
               'Remove-TrustMachineIdentity', 'Remove-TrustTag', 'Remove-CmsTeam',
               'Remove-CmsTeamMember', 'Remove-CmsTeamOwner', 'Remove-TrustWebhook',
               'Remove-CmCertificate', 'Remove-CmCertificateAssociation',
               'Remove-CmClient', 'Remove-CmEngineFolder', 'Remove-CmObject',
               'Remove-CmPermission', 'Remove-CmTeam', 'Remove-CmTeamMember',
               'Remove-CmTeamOwner', 'Rename-CmObject', 'Revoke-CmGrant',
               'Set-CmsApplication',
               'Set-TrustConnector', 'Set-CmsTeam', 'Set-CmAttribute',
               'Set-CmCredential', 'Set-CmPermission',
               'Set-CmWorkflowTicketStatus', 'Test-CmIdentity', 'Test-CmObject',
               'Write-CmLog', 'Set-TrustCertificate',
...
AliasesToExport = @(
               ...
               'New-VcMachineIis', 'New-VcWebhook',
               ...
               'New-VdcCustomField', 'New-VdcDevice', 'New-VdcObject',
               'New-VdcPolicy', 'New-VdcTeam', 'Read-VdcLog',
               'Remove-VdcCertificate', 'Remove-VdcCertificateAssociation', 'Remove-VdcClient',
               ...
               'Set-VdcCredential', 'Set-VdcPermission', 'Set-VdcWorkflowTicketStatus',
               'Test-VdcIdentity', 'Test-VdcObject', 'Write-VdcLog'
           )
